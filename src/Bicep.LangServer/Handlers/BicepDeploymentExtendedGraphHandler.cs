...
{
    [Method("textDocument/deploymentExtendedGraph", Direction.ClientToServer)]
    ...
    public class BicepDeploymentExtendedGraphHandler : IJsonRpcRequestHandler<BicepDeploymentGraphParams, BicepDeploymentGraph?>
    {
        private readonly ILogger<BicepDocumentSymbolHandler> logger;

        private readonly ICompilationManager compilationManager;

        public BicepDeploymentExtendedGraphHandler(ILogger<BicepDocumentSymbolHandler> logger, ICompilationManager compilationManager)
        {
            this.logger = logger;
